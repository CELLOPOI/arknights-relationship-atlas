...
在 `/preferences/`「喜好」页面左侧切换人物与皮肤，支持匿名随机比较、长期厨力与本命、形态和皮肤选择及独立统计。V2 包含 581 个人物、446 个完整形态目录和 1,361 个外观，半身卡面、双上限统计、综合榜及双向切页已完成；名录仍须受控审核发布。运行、参数与验证见[喜好开发说明](docs/PREFERENCES.md)和[V2 验收](docs/PREFERENCES_V2_ACCEPTANCE.md)。公开部署和真实流量试运行不随本地实现自动完成。
