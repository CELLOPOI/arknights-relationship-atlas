...
import { assetDeliveryPlugin, assetVersions } from './scripts/asset-delivery.mjs';
...
export default defineConfig(async ({ command, mode }) => {
  ...
  return {
    define: { __ASSET_VERSIONS__: JSON.stringify(versions) },
    plugins: [assetDeliveryPlugin(versions), vue(), {
