...
保留每周 120 道、连续 28 天 480 道、每人物 28 天最多 3 次展示；新题按无序形态对防重复 84 天，历史无形态任务按原人物对约束。抽样先选人物再选形态，所有形态共享人物曝光额度。派发预留，跳过和自然过期占额；名录发布或明确资源故障作废待答并退额。休息间隔 `PREFERENCE_REST_INTERVAL=50` 与统计 `PREFERENCE_WEIGHT_TOTAL_CAP=50` 独立配置。
